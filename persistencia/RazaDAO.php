...
class RazaDAO {
    ...
    public function consultarTodasLasRazas() {
        return "SELECT idRaza, Raza, Tamaño_idTamaño FROM Raza";
    }

    public function insertarRazaSinTamaño() {
        return "INSERT INTO Raza (Raza, Tamaño_idTamaño) VALUES ('" . $this->nombre . "', 5)";
    }
    public function consultarRazasSinTamaño() {
        return "SELECT idRaza, Raza FROM Raza WHERE Tamaño_idTamaño IS NULL";
    }
    ...
    public function consultarRazasConTamaño() {
        return "SELECT R.idRaza, R.Raza, T.Tamaño
            FROM Raza R
